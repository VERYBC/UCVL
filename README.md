...
This repository contains the dataset and the code for our paper [**UAV Coarse Visual Localization in Large-Scale Continuous Scenes**](https://www.sciencedirect.com/science/article/pii/S0924271626002339?dgcid=coauthor). Thank you for your kindly attention.
...
1. Download the LoFTR model [weight files](https://drive.google.com/drive/folders/1DOcOPZb3-5cWxLqn256AhwUVjBPifhuf) and place them in the `feature_match/LoFTR/weights` directory.
 
2. Fine localization results
